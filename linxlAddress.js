(function(global, factory) {
  ...
  const linxlAddress = function(mixinStr) {
    ...
    _phone = str.match(/((((13[0-9])|(15[^4])|(18[0,1,2,3,5-9])|(17[0-8])|(147))\d{8})|((\d3,4|\d{3,4}-|\s)?\d{7,14}))?/g);
    if (_phone) { //含有phone
      ...
      if (other[0] && other[1]) { // phone在中间
        ...
        _name = getName(provinceList, tempNameAddress) || getName(cityList, tempNameAddress) || getName(countyList, tempNameAddress)
